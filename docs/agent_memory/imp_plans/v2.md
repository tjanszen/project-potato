...
### Tasks
- Build dashboard components for current run, longest run, and total days
- Add run history view with pagination consuming /api/v2/runs
- Integrate totals panel consuming /api/v2/totals
...
- Run history page paginates correctly from API
